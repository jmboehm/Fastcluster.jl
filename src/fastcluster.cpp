...
#include "fastcluster/fastcluster.cpp"
#include "fastcluster/fastcluster_R.cpp"
...
extern "C" {
  ...
  int hclust_fast(int n, double* distmat, int method, int* merge, double* height) {
    ...
    if (method == HCLUST_METHOD_SINGLE) {
      ...
      // complete link
      NN_chain_core<METHOD_METR_WEIGHTED, t_float>(n, distmat, NULL, Z2);
    }
